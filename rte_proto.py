...
class rte_datamodule(pl.LightningDataModule):
    loader_columns = [
        "datasets_idx",
        "input_ids",
        "token_type_ids",
    ...
    def setup(self, stage: str):
        self.dataset = datasets.load_dataset('glue', 'rte')
...
if __name__ == '__main__':
    ...
    rte_dm = rte_datamodule(model_name_or_path=args.model_name,
                        max_seq_length=args.max_seq_length,
                        train_batch_size=args.batch_size,
                        eval_batch_size=args.batch_size)

    rte_dm.setup(stage='fit')
    ...
    tb_logger = TensorBoardLogger(f'{args.logger_dir}', name=f'rte_tensorboard_logs')
    ...
    trainer.fit(proto, datamodule=rte_dm)