...
class GLUEDataModule(pl.LightningDataModule):
    ...
    def convert_to_features(self, example_batch, indices=None):
        ...
        #         print(f'example batch: {example_batch}')
        #         print(f'self.text_fields[0]: {self.text_fields[0]}')
        #         print(f'texts_or_text_pairs: {texts_or_text_pairs}')
...
parser.add_argument('-task_name', default=None, type=str, help='downstream task the model is trying to accomplish')
...
if __name__ == '__main__':
    ...
    print(f'args: {args}')
    #get data module
    sst2_dm = GLUEDataModule(model_name_or_path=args.model_name,
                        task_name=args.task_name,
                        max_seq_length=args.max_seq_length,
                        train_batch_size=args.batch_size,
                        eval_batch_size=args.batch_size)
    sst2_dm.setup(stage='fit')
    ...
    tb_logger = TensorBoardLogger(f'{args.logger_dir}', name=f'sst2_tensorboard_logs')
    ...
    trainer.fit(proto, datamodule=sst2_dm)





    print(f'backbone: {args.model_name}, best_model_path: {checkpoint_callback.best_model_path}')
    print(f'backbone: {args.model_name}, best_model_score: {checkpoint_callback.best_model_score}')