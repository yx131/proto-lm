...
class sst_datamodule(pl.LightningDataModule):
    ...
    def setup(self, stage: str):
        self.dataset = datasets.load_dataset("SetFit/imdb")
...
if __name__ == '__main__':
    ...
    # get data module
    imdb_dm = sst_datamodule(model_name_or_path=args.model_name,
                        max_seq_length=args.max_seq_length,
                        train_batch_size=args.batch_size,
                        eval_batch_size=args.batch_size)


    imdb_dm.setup(stage='fit')
    ...
    tb_logger = TensorBoardLogger(f'{args.logger_dir}', name=f'imdb_tensorboard_logs')
    ...
    trainer.fit(proto, datamodule=imdb_dm)

    # trainer.test(proto, datamodule=imdb_dm, ckpt_path=args.load_model)
    # torch.save(proto.misclassified, 'imdb_logs/misclassed.pt')